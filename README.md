...
6. Writes the verified values to openScale through openScale Provider API 2.
...
| openScale | The installed version must support Provider API 2. |
...
| openScale storage fails | Provider API 2 or permission is missing | Use a compatible openScale version and grant access again. |
